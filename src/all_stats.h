...
class all_stats_c {
	public:
		...
		COUNT_Stat* m_REEXEC_NUM;
		COUNT_Stat* m_INV_MATCH_NUM;
		COUNT_Stat* m_EARLY_PERM_NUM;
		COUNT_Stat* m_PERM_MATCH_NUM;
		COUNT_Stat* m_RETIRE_SPECLD_NUM;
		COUNT_Stat* m_RETIRE_SPECST_NUM;
		COUNT_Stat* m_FENCE_HEAD_ROB_WAIT;
		COUNT_Stat* m_FENCE_TOT_CYCLES;
		COUNT_Stat* m_FENCE_EXEC_CYCLES;
		COUNT_Stat* m_STORE_RES;
		COUNT_Stat* m_STORE_NUM;
		COUNT_Stat* m_STORE_WB_FREE;
		...
		DIST_Stat* m_DIST_FF_CYC_COUNT;
		COUNT_Stat* m_FF_CYC_COUNT;
		COUNT_Stat* m_NON_FF_CYC_COUNT;
		...
		// ============= ../def/hmc.stat.def =============
		COUNT_Stat* m_HMC_INST_COUNT_TOT;
		COUNT_Stat* m_HMC_INST_COUNT;
		COUNT_Stat* m_HMC_UOP_COUNT;
		COUNT_Stat* m_HMC_REMOVE_INST_COUNT;
		COUNT_Stat* m_HMC_REMOVE_INST_COUNT_TOT;
		COUNT_Stat* m_HMC_FENCE_INST_COUNT;
		COUNT_Stat* m_HMC_FENCE_INST_COUNT_TOT;
		COUNT_Stat* m_HMC_ADD_OVERHEAD_COUNT;
		COUNT_Stat* m_HMC_DEP_UOP_CYC_TOT;
		COUNT_Stat* m_HMC_DEP_UOP_RETIRE_COUNT;
		COUNT_Stat* m_HMC_INST_COUNT_CAS_equal_16B;
		COUNT_Stat* m_HMC_INST_COUNT_CAS_zero_16B;
		COUNT_Stat* m_HMC_INST_COUNT_CAS_greater_16B;
		COUNT_Stat* m_HMC_INST_COUNT_CAS_less_16B;
		COUNT_Stat* m_HMC_INST_COUNT_ADD_16B;
		COUNT_Stat* m_HMC_INST_COUNT_ADD_8B;
		COUNT_Stat* m_HMC_INST_COUNT_ADD_DUAL;
		COUNT_Stat* m_HMC_INST_COUNT_SWAP;
		COUNT_Stat* m_HMC_INST_COUNT_BIT_WR;
		COUNT_Stat* m_HMC_INST_COUNT_AND;
		COUNT_Stat* m_HMC_INST_COUNT_NAND;
		COUNT_Stat* m_HMC_INST_COUNT_OR;
		COUNT_Stat* m_HMC_INST_COUNT_XOR;
		COUNT_Stat* m_HMC_INST_COUNT_FP_ADD;
		COUNT_Stat* m_HMC_INST_COUNT_COMP_greater;
		COUNT_Stat* m_HMC_INST_COUNT_COMP_less;
		COUNT_Stat* m_HMC_INST_COUNT_COMP_equal;
		COUNT_Stat* m_HMC_INST_COUNT_CANDIDATE;
		COUNT_Stat* m_HMC_INST_COUNT_HOOK;
		COUNT_Stat* m_HMC_INST_COUNT_UNHOOK;
		COUNT_Stat* m_HMC_INST_COUNT_TRANS_BEG;
		COUNT_Stat* m_HMC_INST_COUNT_TRANS_MID;
		COUNT_Stat* m_HMC_INST_COUNT_TRANS_END;
		
		// ============= ../def/inst.stat.def =============
		DIST_Stat* m_DIST_OP_CAT_XED_CATEGORY_INVALID;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_INVALID;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_3DNOW;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_AES;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_AVX;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_AVX2;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_AVX2GATHER;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_BDW;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_BINARY;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_BITBYTE;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_BMI1;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_BMI2;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_BROADCAST;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_CALL;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_CMOV;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_COND_BR;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_CONVERT;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_DATAXFER;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_DECIMAL;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_FCMOV;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_FLAGOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_FMA4;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_INTERRUPT;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_IO;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_IOSTRINGOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_LOGICAL;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_LZCNT;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_MISC;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_MMX;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_NOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PCLMULQDQ;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_POP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PREFETCH;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PUSH;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_RDRAND;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_RDSEED;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_RDWRFSGS;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_RET;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_ROTATE;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SEGOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SEMAPHORE;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SHIFT;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SSE;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_STRINGOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_STTNI;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SYSCALL;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SYSRET;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SYSTEM;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_TBM;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_UNCOND_BR;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_VFMA;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_VTX;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_WIDENOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_X87_ALU;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_XOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_XSAVE;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_XSAVEOPT;
		...
		COUNT_Stat* m_OP_CAT_GPU_INVALID;
		...
		COUNT_Stat* m_OP_CAT_GPU_ATOM_GM;
		COUNT_Stat* m_OP_CAT_GPU_ATOM_SM;
		COUNT_Stat* m_OP_CAT_GPU_ATOM64_GM;
		COUNT_Stat* m_OP_CAT_GPU_ATOM64_SM;
		COUNT_Stat* m_OP_CAT_GPU_BAR_ARRIVE;
		COUNT_Stat* m_OP_CAT_GPU_BAR_SYNC;
		COUNT_Stat* m_OP_CAT_GPU_BAR_RED;
		...
		COUNT_Stat* m_OP_CAT_GPU_MEMBAR_GL;
		COUNT_Stat* m_OP_CAT_GPU_MEMBAR_SYS;
		...
		COUNT_Stat* m_OP_CAT_GPU_RED_GM;
		COUNT_Stat* m_OP_CAT_GPU_RED_SM;
		COUNT_Stat* m_OP_CAT_GPU_RED64_GM;
		COUNT_Stat* m_OP_CAT_GPU_RED64_SM;
		...
		COUNT_Stat* m_OP_CAT_GPU_MEM_LD_GM;
		COUNT_Stat* m_OP_CAT_GPU_MEM_LD_LM;
		COUNT_Stat* m_OP_CAT_GPU_MEM_LD_SM;
		COUNT_Stat* m_OP_CAT_GPU_MEM_LD_CM;
		COUNT_Stat* m_OP_CAT_GPU_MEM_LD_TM;
		COUNT_Stat* m_OP_CAT_GPU_MEM_LD_PM;
		COUNT_Stat* m_OP_CAT_GPU_MEM_LDU_GM;
		COUNT_Stat* m_OP_CAT_GPU_MEM_ST_GM;
		COUNT_Stat* m_OP_CAT_GPU_MEM_ST_LM;
		COUNT_Stat* m_OP_CAT_GPU_MEM_ST_SM;
		COUNT_Stat* m_OP_CAT_GPU_DATA_XFER_GM;
		COUNT_Stat* m_OP_CAT_GPU_DATA_XFER_LM;
		COUNT_Stat* m_OP_CAT_GPU_DATA_XFER_SM;
		...
		COUNT_Stat* m_NUM_PHYSICAL_PAGES;
