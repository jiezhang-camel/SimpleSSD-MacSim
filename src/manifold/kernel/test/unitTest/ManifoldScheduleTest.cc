...
class MyObj1 {
 ...
 public:
  ...
  void handler4(MyDataType1 d1, MyDataType2 d2, MyDataType3 d3,
                MyDataType4 d4) {
    m_tick = m_clock.NowTicks();
    m_time = Manifold::Now();
    m_d1 = d1;
...
class StaticHandlers {
 ...
 public:
  ...
  static void Static_handler4(MyDataType1 d1, MyDataType2 d2, MyDataType3 d3,
                              MyDataType4 d4) {
    Static_tick = Static_clock->NowTicks();
    Static_time = Manifold::Now();
    Static_d1 = d1;
...
class ManifoldTest : public CppUnit::TestFixture {
 ...
 public:
  ...
  void testSchedule_0() {
    ...
    CPPUNIT_ASSERT_EQUAL(scheduledAt,
  ...
  void testSchedule_2() {
    ...
    Ticks_t WHEN = 6;
    TickEventId te =
        Manifold::Schedule(WHEN, &MyObj1::handler2, comp1, m_d1, m_d2);
    Ticks_t scheduledAt = WHEN + comp1->getClock().NowTicks();
  ...
  void testSchedule_3() {
    ...
    Ticks_t WHEN = 2;
    TickEventId te =
        Manifold::Schedule(WHEN, &MyObj1::handler3, comp1, m_d1, m_d2, m_d3);
    Ticks_t scheduledAt = WHEN + comp1->getClock().NowTicks();
  ...
  /**
   * Test Schedule(Ticks_t, void(T::*handler)(U1, U2, U3, U4), OBJ*, T1, T2, T3,
   * T4)
   */
  void testSchedule_4() {
    Manifold::unhalt();
    Ticks_t WHEN = 3;
    TickEventId te = Manifold::Schedule(WHEN, &MyObj1::handler4, comp1, m_d1,
                                        m_d2, m_d3, m_d4);
    Ticks_t scheduledAt = WHEN + comp1->getClock().NowTicks();
  ...
  void testScheduleHalf_0() {
    ...
    // There are 2 test cases here. We test both even and odd number of half
    // ticks.
    for (int i = 0; i < 2; i++) {
      Manifold::unhalt();
      WHEN += i;
  ...
  void testScheduleHalf_1() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te =
          Manifold::ScheduleHalf(WHEN, &MyObj1::handler1, comp1, m_d1);
      Ticks_t scheduledAt = WHEN / 2 + comp1->getClock().NowTicks();
  ...
  void testScheduleHalf_2() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te =
          Manifold::ScheduleHalf(WHEN, &MyObj1::handler2, comp1, m_d1, m_d2);
      Ticks_t scheduledAt = WHEN / 2 + comp1->getClock().NowTicks();
  ...
  void testScheduleHalf_3() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      WHEN += i;
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleHalf(WHEN, &MyObj1::handler3, comp1,
                                              m_d1, m_d2, m_d3);
      Ticks_t scheduledAt = WHEN / 2 + comp1->getClock().NowTicks();
  ...
  /**
   * Test ScheduleHalf(Ticks_t, void(T::*handler)(U1, U2, U3, U4), OBJ*, T1, T2,
   * T3, T4)
   */
  void testScheduleHalf_4() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      WHEN += i;
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleHalf(WHEN, &MyObj1::handler4, comp1,
                                              m_d1, m_d2, m_d3, m_d4);
      Ticks_t scheduledAt = WHEN / 2 + comp1->getClock().NowTicks();
  ...
  void testScheduleClock_0() {
    ...
    TickEventId te =
        Manifold::ScheduleClock(WHEN, Clock1, &MyObj1::handler0, comp2);
  ...
  void testScheduleClock_1() {
    ...
    TickEventId te =
        Manifold::ScheduleClock(WHEN, Clock1, &MyObj1::handler1, comp2, m_d1);
    Ticks_t scheduledAt = WHEN + comp2->getClock().NowTicks();
  ...
  /**
   * Test ScheduleClock(Ticks_t, Clock&, void(T::*handler)(U1, U2), OBJ*, T1,
   * T2)
   */
  void testScheduleClock_2() {
    ...
    TickEventId te = Manifold::ScheduleClock(WHEN, Clock1, &MyObj1::handler2,
                                             comp2, m_d1, m_d2);
    Ticks_t scheduledAt = WHEN + comp2->getClock().NowTicks();
  ...
  /**
   * Test ScheduleClock(Ticks_t, Clock&, void(T::*handler)(U1, U2, U3), OBJ*,
   * T1, T2, T3)
   */
  void testScheduleClock_3() {
    ...
    TickEventId te = Manifold::ScheduleClock(WHEN, Clock1, &MyObj1::handler3,
                                             comp2, m_d1, m_d2, m_d3);
    Ticks_t scheduledAt = WHEN + comp2->getClock().NowTicks();
  ...
  /**
   * Test ScheduleClock(Ticks_t, Clock&, void(T::*handler)(U1, U2, U3, U4),
   * OBJ*, T1, T2, T3, T4)
   */
  void testScheduleClock_4() {
    ...
    TickEventId te = Manifold::ScheduleClock(WHEN, Clock1, &MyObj1::handler4,
                                             comp2, m_d1, m_d2, m_d3, m_d4);
    Ticks_t scheduledAt = WHEN + comp2->getClock().NowTicks();
  ...
  void testScheduleClockHalf_0() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te =
          Manifold::ScheduleClockHalf(WHEN, Clock1, &MyObj1::handler0, comp2);
  ...
  void testScheduleClockHalf_1() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      WHEN += i;
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleClockHalf(
          WHEN, Clock1, &MyObj1::handler1, comp2, m_d1);
      Ticks_t scheduledAt = WHEN / 2 + comp2->getClock().NowTicks();
  ...
  /**
   * Test ScheduleClockHalf(Ticks_t, Clock&, void(T::*handler)(U1, U2), OBJ*,
   * T1, T2)
   */
  void testScheduleClockHalf_2() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleClockHalf(
          WHEN, Clock1, &MyObj1::handler2, comp2, m_d1, m_d2);
      Ticks_t scheduledAt = WHEN / 2 + comp2->getClock().NowTicks();
  ...
  /**
   * Test ScheduleClockHalf(Ticks_t, Clock&, void(T::*handler)(U1, U2, U3),
   * OBJ*, T1, T2, T3)
   */
  void testScheduleClockHalf_3() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleClockHalf(
          WHEN, Clock1, &MyObj1::handler3, comp2, m_d1, m_d2, m_d3);
      Ticks_t scheduledAt = WHEN / 2 + comp2->getClock().NowTicks();
  ...
  /**
   * Test ScheduleClockHalf(Ticks_t, Clock&, void(T::*handler)(U1, U2, U3, U4),
   * OBJ*, T1, T2, T3, T4)
   */
  void testScheduleClockHalf_4() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleClockHalf(
          WHEN, Clock1, &MyObj1::handler4, comp2, m_d1, m_d2, m_d3, m_d4);
      Ticks_t scheduledAt = WHEN / 2 + comp2->getClock().NowTicks();
  ...
  void testScheduleTime_0() {
    ...
    // verify handler called at right time
    CPPUNIT_ASSERT_DOUBLES_EQUAL(scheduledAt, comp1->getTime(),
                                 DOUBLE_COMP_DELTA);
  }
  ...
  void testScheduleTime_3() {
    ...
    double WHEN = 2.7;
    // Note events are scheduled relative to current time.
    EventId ev = Manifold::ScheduleTime(WHEN, &MyObj1::handler3, comp1, m_d1,
                                        m_d2, m_d3);
    double scheduledAt = WHEN + Manifold::Now();
  ...
  /**
   *  Test ScheduleTime(double, void(T::*handler)(U1, U2, U3, U4), OBJ*, T1, T2,
   * T3, T4)
   */
  void testScheduleTime_4() {
    ...
    double WHEN = 2.7;
    // Note events are scheduled relative to current time.
    EventId ev = Manifold::ScheduleTime(WHEN, &MyObj1::handler4, comp1, m_d1,
                                        m_d2, m_d3, m_d4);
    double scheduledAt = WHEN + Manifold::Now();
  ...
  void testSchedule_s1() {
    ...
    TickEventId te =
        Manifold::Schedule(WHEN, &StaticHandlers::Static_handler1, m_d1);
    Ticks_t scheduledAt = WHEN + StaticHandlers::GetClock().NowTicks();
  ...
  void testSchedule_s2() {
    ...
    TickEventId te =
        Manifold::Schedule(WHEN, &StaticHandlers::Static_handler2, m_d1, m_d2);
    Ticks_t scheduledAt = WHEN + StaticHandlers::GetClock().NowTicks();
  ...
  void testSchedule_s3() {
    ...
    TickEventId te = Manifold::Schedule(WHEN, &StaticHandlers::Static_handler3,
                                        m_d1, m_d2, m_d3);
    Ticks_t scheduledAt = WHEN + StaticHandlers::GetClock().NowTicks();
  ...
  void testSchedule_s4() {
    ...
    TickEventId te = Manifold::Schedule(WHEN, &StaticHandlers::Static_handler4,
                                        m_d1, m_d2, m_d3, m_d4);
    Ticks_t scheduledAt = WHEN + StaticHandlers::GetClock().NowTicks();
    ...
    // verify handler called with right parameters
    CPPUNIT_ASSERT(
        StaticHandlers::getD1() == m_d1 && StaticHandlers::getD2() == m_d2 &&
  ...
  void testScheduleHalf_s0() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te =
          Manifold::ScheduleHalf(WHEN, StaticHandlers::Static_handler0);
  ...
  void testScheduleHalf_s1() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te =
          Manifold::ScheduleHalf(WHEN, StaticHandlers::Static_handler1, m_d1);
      Ticks_t scheduledAt = WHEN / 2 + StaticHandlers::GetClock().NowTicks();
  ...
  void testScheduleHalf_s2() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      WHEN += i;
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleHalf(
          WHEN, StaticHandlers::Static_handler2, m_d1, m_d2);
      Ticks_t scheduledAt = WHEN / 2 + StaticHandlers::GetClock().NowTicks();
  ...
  void testScheduleHalf_s3() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleHalf(
          WHEN, StaticHandlers::Static_handler3, m_d1, m_d2, m_d3);
      Ticks_t scheduledAt = WHEN / 2 + StaticHandlers::GetClock().NowTicks();
  ...
  void testScheduleHalf_s4() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleHalf(
          WHEN, StaticHandlers::Static_handler4, m_d1, m_d2, m_d3, m_d4);
      Ticks_t scheduledAt = WHEN / 2 + StaticHandlers::GetClock().NowTicks();
  ...
  void testScheduleClock_s0() {
    ...
    TickEventId te =
        Manifold::ScheduleClock(WHEN, Clock1, StaticHandlers::Static_handler0);
    Ticks_t scheduledAt = WHEN + StaticHandlers::GetClock().NowTicks();
  ...
  void testScheduleClock_s1() {
    ...
    TickEventId te = Manifold::ScheduleClock(
        WHEN, Clock1, StaticHandlers::Static_handler1, m_d1);
    Ticks_t scheduledAt = WHEN + StaticHandlers::GetClock().NowTicks();
  ...
  void testScheduleClock_s2() {
    ...
    TickEventId te = Manifold::ScheduleClock(
        WHEN, Clock1, StaticHandlers::Static_handler2, m_d1, m_d2);
    Ticks_t scheduledAt = WHEN + StaticHandlers::GetClock().NowTicks();
  ...
  void testScheduleClock_s3() {
    ...
    TickEventId te = Manifold::ScheduleClock(
        WHEN, Clock1, StaticHandlers::Static_handler3, m_d1, m_d2, m_d3);
    Ticks_t scheduledAt = WHEN + StaticHandlers::GetClock().NowTicks();
  ...
  /**
   * Test ScheduleClock(Ticks_t, Clock&, void(*handler)(U1, U2, U3, U4), T1, T2,
   * T3, T4)
   */
  void testScheduleClock_s4() {
    ...
    TickEventId te = Manifold::ScheduleClock(
        WHEN, Clock1, StaticHandlers::Static_handler4, m_d1, m_d2, m_d3, m_d4);
    Ticks_t scheduledAt = WHEN + StaticHandlers::GetClock().NowTicks();
  ...
  //======================================================================
  // The following set of functions test ScheduleClockHalf() for static
  // callbacks.
  //======================================================================
  /**
  ...
  void testScheduleClockHalf_s0() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleClockHalf(
          WHEN, Clock1, StaticHandlers::Static_handler0);
      Ticks_t scheduledAt = WHEN / 2 + StaticHandlers::GetClock().NowTicks();
  ...
  /**
   * Test ScheduleClockHalf(Ticks_t, Clock&, void(*handler)(U1, U2, U3), T1, T2,
   * T3)
   */
  ...
  /**
   * Test ScheduleClockHalf(Ticks_t, Clock&, void(*handler)(U1, U2, U3, U4), T1,
   * T2, T3, T4)
   */
  void testScheduleClockHalf_s4() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Note events are scheduled relative to current clock ticks.
      TickEventId te = Manifold::ScheduleClockHalf(
          WHEN, Clock1, StaticHandlers::Static_handler4, m_d1, m_d2, m_d3,
          m_d4);
      Ticks_t scheduledAt = WHEN / 2 + StaticHandlers::GetClock().NowTicks();
  ...
  void testScheduleTime_s0() {
    ...
    // verify handler called at right time
    CPPUNIT_ASSERT_DOUBLES_EQUAL(scheduledAt, StaticHandlers::getTime(),
                                 DOUBLE_COMP_DELTA);
  }
  ...
  void testScheduleTime_s2() {
    ...
    double WHEN = 3.4;
    // Note events are scheduled relative to current time.
    EventId ev = Manifold::ScheduleTime(WHEN, StaticHandlers::Static_handler2,
                                        m_d1, m_d2);
    double scheduledAt = WHEN + Manifold::Now();
  ...
  void testScheduleTime_s3() {
    ...
    double WHEN = 3.4;
    // Note events are scheduled relative to current time.
    EventId ev = Manifold::ScheduleTime(WHEN, StaticHandlers::Static_handler3,
                                        m_d1, m_d2, m_d3);
    double scheduledAt = WHEN + Manifold::Now();
  ...
  void testScheduleTime_s4() {
    ...
    double WHEN = 3.4;
    // Note events are scheduled relative to current time.
    EventId ev = Manifold::ScheduleTime(WHEN, StaticHandlers::Static_handler4,
                                        m_d1, m_d2, m_d3, m_d4);
    double scheduledAt = WHEN + Manifold::Now();
  ...
  static CppUnit::Test *suite() {
    ...
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testSchedule_0", &ManifoldTest::testSchedule_0));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testSchedule_1", &ManifoldTest::testSchedule_1));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testSchedule_2", &ManifoldTest::testSchedule_2));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testSchedule_3", &ManifoldTest::testSchedule_3));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testSchedule_4", &ManifoldTest::testSchedule_4));

    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleHalf_0", &ManifoldTest::testScheduleHalf_0));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleHalf_1", &ManifoldTest::testScheduleHalf_1));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleHalf_2", &ManifoldTest::testScheduleHalf_2));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleHalf_3", &ManifoldTest::testScheduleHalf_3));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleHalf_4", &ManifoldTest::testScheduleHalf_4));

    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClock_0", &ManifoldTest::testScheduleClock_0));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClock_1", &ManifoldTest::testScheduleClock_1));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClock_2", &ManifoldTest::testScheduleClock_2));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClock_3", &ManifoldTest::testScheduleClock_3));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClock_4", &ManifoldTest::testScheduleClock_4));

    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClockHalf_0", &ManifoldTest::testScheduleClockHalf_0));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClockHalf_1", &ManifoldTest::testScheduleClockHalf_1));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClockHalf_2", &ManifoldTest::testScheduleClockHalf_2));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClockHalf_3", &ManifoldTest::testScheduleClockHalf_3));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClockHalf_4", &ManifoldTest::testScheduleClockHalf_4));

    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleTime_0", &ManifoldTest::testScheduleTime_0));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleTime_1", &ManifoldTest::testScheduleTime_1));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleTime_2", &ManifoldTest::testScheduleTime_2));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleTime_3", &ManifoldTest::testScheduleTime_3));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleTime_4", &ManifoldTest::testScheduleTime_4));

    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testSchedule_s0", &ManifoldTest::testSchedule_s0));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testSchedule_s1", &ManifoldTest::testSchedule_s1));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testSchedule_s2", &ManifoldTest::testSchedule_s2));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testSchedule_s3", &ManifoldTest::testSchedule_s3));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testSchedule_s4", &ManifoldTest::testSchedule_s4));

    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleHalf_s0", &ManifoldTest::testScheduleHalf_s0));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleHalf_s1", &ManifoldTest::testScheduleHalf_s1));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleHalf_s2", &ManifoldTest::testScheduleHalf_s2));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleHalf_s3", &ManifoldTest::testScheduleHalf_s3));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleHalf_s4", &ManifoldTest::testScheduleHalf_s4));

    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClock_s0", &ManifoldTest::testScheduleClock_s0));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClock_s1", &ManifoldTest::testScheduleClock_s1));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClock_s2", &ManifoldTest::testScheduleClock_s2));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClock_s3", &ManifoldTest::testScheduleClock_s3));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClock_s4", &ManifoldTest::testScheduleClock_s4));

    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClockHalf_s0", &ManifoldTest::testScheduleClockHalf_s0));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClockHalf_s1", &ManifoldTest::testScheduleClockHalf_s1));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClockHalf_s2", &ManifoldTest::testScheduleClockHalf_s2));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClockHalf_s3", &ManifoldTest::testScheduleClockHalf_s3));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleClockHalf_s4", &ManifoldTest::testScheduleClockHalf_s4));

    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleTime_s0", &ManifoldTest::testScheduleTime_s0));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleTime_s1", &ManifoldTest::testScheduleTime_s1));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleTime_s2", &ManifoldTest::testScheduleTime_s2));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleTime_s3", &ManifoldTest::testScheduleTime_s3));
    mySuite->addTest(new CppUnit::TestCaller<ManifoldTest>(
        "testScheduleTime_s4", &ManifoldTest::testScheduleTime_s4));
    /*
     */
