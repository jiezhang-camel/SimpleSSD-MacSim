...
#define PARM_in_share_buf \
  0 /* do input virtual channels physically share buffers? */
#define PARM_out_share_buf \
  0 /* do output virtual channels physically share buffers? */
/* ?? */
#define PARM_in_share_switch \
  1 /* do input virtual channels share crossbar input ports? */
...
#define PARM_vc_select_buf_type \
  REGISTER /* vc_select buffer type, SRAM or REGISTER */
