...
all_knobs_c::all_knobs_c() {
	...
	KNOB_DYFR_SAMPLE_PERIOD = new KnobTemplate< int > ("dyfr_sample_period", 4000000);
	...
	KNOB_ENABLE_FAST_FORWARD_MODE = new KnobTemplate< bool > ("enable_fast_forward_mode", false);
	KNOB_FAST_FORWARD_MODE_THRESHOLD = new KnobTemplate< uns > ("fast_forward_mode_threshold", 1000);
	...
	KNOB_ENABLE_HMC_BYPASS_CACHE = new KnobTemplate< bool > ("enable_hmc_bypass_cache", 1);
	...
	KNOB_ENABLE_HMC_DOUBLE_FENCE = new KnobTemplate< bool > ("enable_hmc_double_fence", 0);
	KNOB_COUNT_HMC_REMOVED_IN_MAX_INSTS = new KnobTemplate< bool > ("count_hmc_removed_in_max_insts", 0);
	KNOB_HMC_ADD_DEP = new KnobTemplate< bool > ("hmc_add_dep", 1);
	KNOB_ENABLE_TRACE_MAX_THREAD = new KnobTemplate< bool > ("enable_trace_max_thread", 0);
	KNOB_TRACE_MAX_THREAD_COUNT = new KnobTemplate< int > ("trace_max_thread_count", 8);
	...
	KNOB_RAMULATOR_CONFIG_FILE = new KnobTemplate< string > ("ramulator_config_file", "../src/ramulator/configs/GDDR5-config.cfg");
	KNOB_RAMULATOR_CACHELINE_SIZE = new KnobTemplate< int > ("ramulator_cacheline_size", 128);
