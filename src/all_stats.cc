...
all_stats_c::all_stats_c(ProcessorStatistics* procStat) {
	...
	m_INV_MATCH_NUM = new COUNT_Stat("INV_MATCH_NUM", "core.stat.out", INV_MATCH_NUM);
	m_EARLY_PERM_NUM = new COUNT_Stat("EARLY_PERM_NUM", "core.stat.out", EARLY_PERM_NUM);
	m_PERM_MATCH_NUM = new COUNT_Stat("PERM_MATCH_NUM", "core.stat.out", PERM_MATCH_NUM);
	m_RETIRE_SPECLD_NUM = new COUNT_Stat("RETIRE_SPECLD_NUM", "core.stat.out", RETIRE_SPECLD_NUM);
	m_RETIRE_SPECST_NUM = new COUNT_Stat("RETIRE_SPECST_NUM", "core.stat.out", RETIRE_SPECST_NUM);
	m_FENCE_HEAD_ROB_WAIT = new COUNT_Stat("FENCE_HEAD_ROB_WAIT", "core.stat.out", FENCE_HEAD_ROB_WAIT);
	m_FENCE_TOT_CYCLES = new COUNT_Stat("FENCE_TOT_CYCLES", "core.stat.out", FENCE_TOT_CYCLES);
	m_FENCE_EXEC_CYCLES = new COUNT_Stat("FENCE_EXEC_CYCLES", "core.stat.out", FENCE_EXEC_CYCLES);
	m_STORE_RES = new COUNT_Stat("STORE_RES", "core.stat.out", STORE_RES);
	m_STORE_NUM = new COUNT_Stat("STORE_NUM", "core.stat.out", STORE_NUM);
	m_STORE_WB_FREE = new COUNT_Stat("STORE_WB_FREE", "core.stat.out", STORE_WB_FREE);
	...
	m_DIST_FF_CYC_COUNT = new DIST_Stat("FF_CYC_COUNT", "general.stat.out", FF_CYC_COUNT, procStat);
	m_FF_CYC_COUNT = (COUNT_Stat*) new DISTMember_Stat("FF_CYC_COUNT", "general.stat.out", FF_CYC_COUNT, FF_CYC_COUNT);
	m_NON_FF_CYC_COUNT = (COUNT_Stat*) new DISTMember_Stat("NON_FF_CYC_COUNT", "general.stat.out", NON_FF_CYC_COUNT, FF_CYC_COUNT);
	...
	// ============= ../def/hmc.stat.def =============
	m_HMC_INST_COUNT_TOT = new COUNT_Stat("HMC_INST_COUNT_TOT", "hmc.stat.out", HMC_INST_COUNT_TOT);
	...
	m_HMC_REMOVE_INST_COUNT = new COUNT_Stat("HMC_REMOVE_INST_COUNT", "hmc.stat.out", HMC_REMOVE_INST_COUNT);
	m_HMC_REMOVE_INST_COUNT_TOT = new COUNT_Stat("HMC_REMOVE_INST_COUNT_TOT", "hmc.stat.out", HMC_REMOVE_INST_COUNT_TOT);
	m_HMC_FENCE_INST_COUNT = new COUNT_Stat("HMC_FENCE_INST_COUNT", "hmc.stat.out", HMC_FENCE_INST_COUNT);
	m_HMC_FENCE_INST_COUNT_TOT = new COUNT_Stat("HMC_FENCE_INST_COUNT_TOT", "hmc.stat.out", HMC_FENCE_INST_COUNT_TOT);
	m_HMC_ADD_OVERHEAD_COUNT = new COUNT_Stat("HMC_ADD_OVERHEAD_COUNT", "hmc.stat.out", HMC_ADD_OVERHEAD_COUNT);
	m_HMC_DEP_UOP_CYC_TOT = new COUNT_Stat("HMC_DEP_UOP_CYC_TOT", "hmc.stat.out", HMC_DEP_UOP_CYC_TOT);
	m_HMC_DEP_UOP_RETIRE_COUNT = new COUNT_Stat("HMC_DEP_UOP_RETIRE_COUNT", "hmc.stat.out", HMC_DEP_UOP_RETIRE_COUNT);
	m_HMC_INST_COUNT_CAS_equal_16B = new COUNT_Stat("HMC_INST_COUNT_CAS_equal_16B", "hmc.stat.out", HMC_INST_COUNT_CAS_equal_16B);
	m_HMC_INST_COUNT_CAS_zero_16B = new COUNT_Stat("HMC_INST_COUNT_CAS_zero_16B", "hmc.stat.out", HMC_INST_COUNT_CAS_zero_16B);
	m_HMC_INST_COUNT_CAS_greater_16B = new COUNT_Stat("HMC_INST_COUNT_CAS_greater_16B", "hmc.stat.out", HMC_INST_COUNT_CAS_greater_16B);
	m_HMC_INST_COUNT_CAS_less_16B = new COUNT_Stat("HMC_INST_COUNT_CAS_less_16B", "hmc.stat.out", HMC_INST_COUNT_CAS_less_16B);
	m_HMC_INST_COUNT_ADD_16B = new COUNT_Stat("HMC_INST_COUNT_ADD_16B", "hmc.stat.out", HMC_INST_COUNT_ADD_16B);
	m_HMC_INST_COUNT_ADD_8B = new COUNT_Stat("HMC_INST_COUNT_ADD_8B", "hmc.stat.out", HMC_INST_COUNT_ADD_8B);
	m_HMC_INST_COUNT_ADD_DUAL = new COUNT_Stat("HMC_INST_COUNT_ADD_DUAL", "hmc.stat.out", HMC_INST_COUNT_ADD_DUAL);
	m_HMC_INST_COUNT_SWAP = new COUNT_Stat("HMC_INST_COUNT_SWAP", "hmc.stat.out", HMC_INST_COUNT_SWAP);
	m_HMC_INST_COUNT_BIT_WR = new COUNT_Stat("HMC_INST_COUNT_BIT_WR", "hmc.stat.out", HMC_INST_COUNT_BIT_WR);
	m_HMC_INST_COUNT_AND = new COUNT_Stat("HMC_INST_COUNT_AND", "hmc.stat.out", HMC_INST_COUNT_AND);
	m_HMC_INST_COUNT_NAND = new COUNT_Stat("HMC_INST_COUNT_NAND", "hmc.stat.out", HMC_INST_COUNT_NAND);
	m_HMC_INST_COUNT_OR = new COUNT_Stat("HMC_INST_COUNT_OR", "hmc.stat.out", HMC_INST_COUNT_OR);
	m_HMC_INST_COUNT_XOR = new COUNT_Stat("HMC_INST_COUNT_XOR", "hmc.stat.out", HMC_INST_COUNT_XOR);
	m_HMC_INST_COUNT_FP_ADD = new COUNT_Stat("HMC_INST_COUNT_FP_ADD", "hmc.stat.out", HMC_INST_COUNT_FP_ADD);
	m_HMC_INST_COUNT_COMP_greater = new COUNT_Stat("HMC_INST_COUNT_COMP_greater", "hmc.stat.out", HMC_INST_COUNT_COMP_greater);
	m_HMC_INST_COUNT_COMP_less = new COUNT_Stat("HMC_INST_COUNT_COMP_less", "hmc.stat.out", HMC_INST_COUNT_COMP_less);
	m_HMC_INST_COUNT_COMP_equal = new COUNT_Stat("HMC_INST_COUNT_COMP_equal", "hmc.stat.out", HMC_INST_COUNT_COMP_equal);
	m_HMC_INST_COUNT_CANDIDATE = new COUNT_Stat("HMC_INST_COUNT_CANDIDATE", "hmc.stat.out", HMC_INST_COUNT_CANDIDATE);
	m_HMC_INST_COUNT_HOOK = new COUNT_Stat("HMC_INST_COUNT_HOOK", "hmc.stat.out", HMC_INST_COUNT_HOOK);
	m_HMC_INST_COUNT_UNHOOK = new COUNT_Stat("HMC_INST_COUNT_UNHOOK", "hmc.stat.out", HMC_INST_COUNT_UNHOOK);
	m_HMC_INST_COUNT_TRANS_BEG = new COUNT_Stat("HMC_INST_COUNT_TRANS_BEG", "hmc.stat.out", HMC_INST_COUNT_TRANS_BEG);
	m_HMC_INST_COUNT_TRANS_MID = new COUNT_Stat("HMC_INST_COUNT_TRANS_MID", "hmc.stat.out", HMC_INST_COUNT_TRANS_MID);
	m_HMC_INST_COUNT_TRANS_END = new COUNT_Stat("HMC_INST_COUNT_TRANS_END", "hmc.stat.out", HMC_INST_COUNT_TRANS_END);
	...
	m_OP_CAT_XED_CATEGORY_INVALID = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_INVALID", "inst.stat.out", OP_CAT_XED_CATEGORY_INVALID, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_3DNOW = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_3DNOW", "inst.stat.out", OP_CAT_XED_CATEGORY_3DNOW, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_AES = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_AES", "inst.stat.out", OP_CAT_XED_CATEGORY_AES, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_AVX = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_AVX", "inst.stat.out", OP_CAT_XED_CATEGORY_AVX, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_AVX2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_AVX2", "inst.stat.out", OP_CAT_XED_CATEGORY_AVX2, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_AVX2GATHER = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_AVX2GATHER", "inst.stat.out", OP_CAT_XED_CATEGORY_AVX2GATHER, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_BDW = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_BDW", "inst.stat.out", OP_CAT_XED_CATEGORY_BDW, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_BINARY = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_BINARY", "inst.stat.out", OP_CAT_XED_CATEGORY_BINARY, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_BITBYTE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_BITBYTE", "inst.stat.out", OP_CAT_XED_CATEGORY_BITBYTE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_BMI1 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_BMI1", "inst.stat.out", OP_CAT_XED_CATEGORY_BMI1, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_BMI2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_BMI2", "inst.stat.out", OP_CAT_XED_CATEGORY_BMI2, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_BROADCAST = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_BROADCAST", "inst.stat.out", OP_CAT_XED_CATEGORY_BROADCAST, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_CALL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_CALL", "inst.stat.out", OP_CAT_XED_CATEGORY_CALL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_CMOV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_CMOV", "inst.stat.out", OP_CAT_XED_CATEGORY_CMOV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_COND_BR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_COND_BR", "inst.stat.out", OP_CAT_XED_CATEGORY_COND_BR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_CONVERT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_CONVERT", "inst.stat.out", OP_CAT_XED_CATEGORY_CONVERT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_DATAXFER = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_DATAXFER", "inst.stat.out", OP_CAT_XED_CATEGORY_DATAXFER, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_DECIMAL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_DECIMAL", "inst.stat.out", OP_CAT_XED_CATEGORY_DECIMAL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_FCMOV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_FCMOV", "inst.stat.out", OP_CAT_XED_CATEGORY_FCMOV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_FLAGOP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_FLAGOP", "inst.stat.out", OP_CAT_XED_CATEGORY_FLAGOP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_FMA4 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_FMA4", "inst.stat.out", OP_CAT_XED_CATEGORY_FMA4, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_INTERRUPT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_INTERRUPT", "inst.stat.out", OP_CAT_XED_CATEGORY_INTERRUPT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_IO = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_IO", "inst.stat.out", OP_CAT_XED_CATEGORY_IO, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_IOSTRINGOP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_IOSTRINGOP", "inst.stat.out", OP_CAT_XED_CATEGORY_IOSTRINGOP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_LOGICAL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_LOGICAL", "inst.stat.out", OP_CAT_XED_CATEGORY_LOGICAL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_LZCNT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_LZCNT", "inst.stat.out", OP_CAT_XED_CATEGORY_LZCNT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_MISC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_MISC", "inst.stat.out", OP_CAT_XED_CATEGORY_MISC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_MMX = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_MMX", "inst.stat.out", OP_CAT_XED_CATEGORY_MMX, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_NOP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_NOP", "inst.stat.out", OP_CAT_XED_CATEGORY_NOP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_PCLMULQDQ = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PCLMULQDQ", "inst.stat.out", OP_CAT_XED_CATEGORY_PCLMULQDQ, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_POP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_POP", "inst.stat.out", OP_CAT_XED_CATEGORY_POP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_PREFETCH = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PREFETCH", "inst.stat.out", OP_CAT_XED_CATEGORY_PREFETCH, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_PUSH = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PUSH", "inst.stat.out", OP_CAT_XED_CATEGORY_PUSH, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_RDRAND = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_RDRAND", "inst.stat.out", OP_CAT_XED_CATEGORY_RDRAND, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_RDSEED = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_RDSEED", "inst.stat.out", OP_CAT_XED_CATEGORY_RDSEED, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_RDWRFSGS = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_RDWRFSGS", "inst.stat.out", OP_CAT_XED_CATEGORY_RDWRFSGS, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_RET = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_RET", "inst.stat.out", OP_CAT_XED_CATEGORY_RET, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_ROTATE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_ROTATE", "inst.stat.out", OP_CAT_XED_CATEGORY_ROTATE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_SEGOP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SEGOP", "inst.stat.out", OP_CAT_XED_CATEGORY_SEGOP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_SEMAPHORE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SEMAPHORE", "inst.stat.out", OP_CAT_XED_CATEGORY_SEMAPHORE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_SHIFT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SHIFT", "inst.stat.out", OP_CAT_XED_CATEGORY_SHIFT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_SSE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SSE", "inst.stat.out", OP_CAT_XED_CATEGORY_SSE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_STRINGOP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_STRINGOP", "inst.stat.out", OP_CAT_XED_CATEGORY_STRINGOP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_STTNI = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_STTNI", "inst.stat.out", OP_CAT_XED_CATEGORY_STTNI, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_SYSCALL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SYSCALL", "inst.stat.out", OP_CAT_XED_CATEGORY_SYSCALL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_SYSRET = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SYSRET", "inst.stat.out", OP_CAT_XED_CATEGORY_SYSRET, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_SYSTEM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SYSTEM", "inst.stat.out", OP_CAT_XED_CATEGORY_SYSTEM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_TBM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_TBM", "inst.stat.out", OP_CAT_XED_CATEGORY_TBM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_UNCOND_BR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_UNCOND_BR", "inst.stat.out", OP_CAT_XED_CATEGORY_UNCOND_BR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_VFMA = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_VFMA", "inst.stat.out", OP_CAT_XED_CATEGORY_VFMA, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_VTX = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_VTX", "inst.stat.out", OP_CAT_XED_CATEGORY_VTX, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_WIDENOP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_WIDENOP", "inst.stat.out", OP_CAT_XED_CATEGORY_WIDENOP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_X87_ALU = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_X87_ALU", "inst.stat.out", OP_CAT_XED_CATEGORY_X87_ALU, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_XOP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_XOP", "inst.stat.out", OP_CAT_XED_CATEGORY_XOP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_XSAVE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_XSAVE", "inst.stat.out", OP_CAT_XED_CATEGORY_XSAVE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_XSAVEOPT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_XSAVEOPT", "inst.stat.out", OP_CAT_XED_CATEGORY_XSAVEOPT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_TR_MUL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_TR_MUL", "inst.stat.out", OP_CAT_TR_MUL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_TR_DIV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_TR_DIV", "inst.stat.out", OP_CAT_TR_DIV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_TR_FMUL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_TR_FMUL", "inst.stat.out", OP_CAT_TR_FMUL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_TR_FDIV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_TR_FDIV", "inst.stat.out", OP_CAT_TR_FDIV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_TR_NOP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_TR_NOP", "inst.stat.out", OP_CAT_TR_NOP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_PREFETCH_NTA = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_PREFETCH_NTA", "inst.stat.out", OP_CAT_PREFETCH_NTA, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_PREFETCH_T0 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_PREFETCH_T0", "inst.stat.out", OP_CAT_PREFETCH_T0, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_PREFETCH_T1 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_PREFETCH_T1", "inst.stat.out", OP_CAT_PREFETCH_T1, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_PREFETCH_T2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_PREFETCH_T2", "inst.stat.out", OP_CAT_PREFETCH_T2, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_EN = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_EN", "inst.stat.out", OP_CAT_GPU_EN, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_INVALID = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_INVALID", "inst.stat.out", OP_CAT_GPU_INVALID, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ABS = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ABS", "inst.stat.out", OP_CAT_GPU_ABS, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ABS64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ABS64", "inst.stat.out", OP_CAT_GPU_ABS64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ADD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ADD", "inst.stat.out", OP_CAT_GPU_ADD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ADD64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ADD64", "inst.stat.out", OP_CAT_GPU_ADD64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ADDC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ADDC", "inst.stat.out", OP_CAT_GPU_ADDC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_AND = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_AND", "inst.stat.out", OP_CAT_GPU_AND, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_AND64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_AND64", "inst.stat.out", OP_CAT_GPU_AND64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ATOM_GM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ATOM_GM", "inst.stat.out", OP_CAT_GPU_ATOM_GM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ATOM_SM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ATOM_SM", "inst.stat.out", OP_CAT_GPU_ATOM_SM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ATOM64_GM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ATOM64_GM", "inst.stat.out", OP_CAT_GPU_ATOM64_GM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ATOM64_SM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ATOM64_SM", "inst.stat.out", OP_CAT_GPU_ATOM64_SM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BAR_ARRIVE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BAR_ARRIVE", "inst.stat.out", OP_CAT_GPU_BAR_ARRIVE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BAR_SYNC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BAR_SYNC", "inst.stat.out", OP_CAT_GPU_BAR_SYNC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BAR_RED = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BAR_RED", "inst.stat.out", OP_CAT_GPU_BAR_RED, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BFE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BFE", "inst.stat.out", OP_CAT_GPU_BFE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BFE64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BFE64", "inst.stat.out", OP_CAT_GPU_BFE64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BFI = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BFI", "inst.stat.out", OP_CAT_GPU_BFI, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BFI64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BFI64", "inst.stat.out", OP_CAT_GPU_BFI64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BFIND = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BFIND", "inst.stat.out", OP_CAT_GPU_BFIND, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BFIND64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BFIND64", "inst.stat.out", OP_CAT_GPU_BFIND64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BRA = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BRA", "inst.stat.out", OP_CAT_GPU_BRA, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BREV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BREV", "inst.stat.out", OP_CAT_GPU_BREV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BREV64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BREV64", "inst.stat.out", OP_CAT_GPU_BREV64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_BRKPT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_BRKPT", "inst.stat.out", OP_CAT_GPU_BRKPT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_CALL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_CALL", "inst.stat.out", OP_CAT_GPU_CALL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_CLZ = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_CLZ", "inst.stat.out", OP_CAT_GPU_CLZ, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_CLZ64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_CLZ64", "inst.stat.out", OP_CAT_GPU_CLZ64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_CNOT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_CNOT", "inst.stat.out", OP_CAT_GPU_CNOT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_CNOT64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_CNOT64", "inst.stat.out", OP_CAT_GPU_CNOT64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_COPYSIGN = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_COPYSIGN", "inst.stat.out", OP_CAT_GPU_COPYSIGN, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_COPYSIGN64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_COPYSIGN64", "inst.stat.out", OP_CAT_GPU_COPYSIGN64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_COS = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_COS", "inst.stat.out", OP_CAT_GPU_COS, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_CVT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_CVT", "inst.stat.out", OP_CAT_GPU_CVT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_CVT64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_CVT64", "inst.stat.out", OP_CAT_GPU_CVT64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_CVTA = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_CVTA", "inst.stat.out", OP_CAT_GPU_CVTA, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_CVTA64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_CVTA64", "inst.stat.out", OP_CAT_GPU_CVTA64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_DIV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_DIV", "inst.stat.out", OP_CAT_GPU_DIV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_DIV64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_DIV64", "inst.stat.out", OP_CAT_GPU_DIV64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_EX2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_EX2", "inst.stat.out", OP_CAT_GPU_EX2, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_EXIT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_EXIT", "inst.stat.out", OP_CAT_GPU_EXIT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_FMA = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_FMA", "inst.stat.out", OP_CAT_GPU_FMA, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_FMA64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_FMA64", "inst.stat.out", OP_CAT_GPU_FMA64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ISSPACEP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ISSPACEP", "inst.stat.out", OP_CAT_GPU_ISSPACEP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_LD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_LD", "inst.stat.out", OP_CAT_GPU_LD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_LD64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_LD64", "inst.stat.out", OP_CAT_GPU_LD64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_LDU = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_LDU", "inst.stat.out", OP_CAT_GPU_LDU, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_LDU64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_LDU64", "inst.stat.out", OP_CAT_GPU_LDU64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_LG2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_LG2", "inst.stat.out", OP_CAT_GPU_LG2, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_GPU_MEMBAR_GL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEMBAR_GL", "inst.stat.out", OP_CAT_GPU_MEMBAR_GL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEMBAR_SYS = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEMBAR_SYS", "inst.stat.out", OP_CAT_GPU_MEMBAR_SYS, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MIN = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MIN", "inst.stat.out", OP_CAT_GPU_MIN, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MIN64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MIN64", "inst.stat.out", OP_CAT_GPU_MIN64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MOV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MOV", "inst.stat.out", OP_CAT_GPU_MOV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MOV64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MOV64", "inst.stat.out", OP_CAT_GPU_MOV64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MUL24 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MUL24", "inst.stat.out", OP_CAT_GPU_MUL24, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MUL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MUL", "inst.stat.out", OP_CAT_GPU_MUL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MUL64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MUL64", "inst.stat.out", OP_CAT_GPU_MUL64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_NEG = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_NEG", "inst.stat.out", OP_CAT_GPU_NEG, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_NEG64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_NEG64", "inst.stat.out", OP_CAT_GPU_NEG64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_NOT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_NOT", "inst.stat.out", OP_CAT_GPU_NOT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_NOT64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_NOT64", "inst.stat.out", OP_CAT_GPU_NOT64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_OR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_OR", "inst.stat.out", OP_CAT_GPU_OR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_OR64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_OR64", "inst.stat.out", OP_CAT_GPU_OR64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_PMEVENT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_PMEVENT", "inst.stat.out", OP_CAT_GPU_PMEVENT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_POPC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_POPC", "inst.stat.out", OP_CAT_GPU_POPC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_POPC64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_POPC64", "inst.stat.out", OP_CAT_GPU_POPC64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_PREFETCH = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_PREFETCH", "inst.stat.out", OP_CAT_GPU_PREFETCH, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_PREFETCHU = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_PREFETCHU", "inst.stat.out", OP_CAT_GPU_PREFETCHU, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_PRMT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_PRMT", "inst.stat.out", OP_CAT_GPU_PRMT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_RCP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_RCP", "inst.stat.out", OP_CAT_GPU_RCP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_RCP64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_RCP64", "inst.stat.out", OP_CAT_GPU_RCP64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_RED_GM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_RED_GM", "inst.stat.out", OP_CAT_GPU_RED_GM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_RED_SM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_RED_SM", "inst.stat.out", OP_CAT_GPU_RED_SM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_RED64_GM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_RED64_GM", "inst.stat.out", OP_CAT_GPU_RED64_GM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_RED64_SM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_RED64_SM", "inst.stat.out", OP_CAT_GPU_RED64_SM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_REM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_REM", "inst.stat.out", OP_CAT_GPU_REM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_REM64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_REM64", "inst.stat.out", OP_CAT_GPU_REM64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_RET = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_RET", "inst.stat.out", OP_CAT_GPU_RET, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_RSQRT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_RSQRT", "inst.stat.out", OP_CAT_GPU_RSQRT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_RSQRT64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_RSQRT64", "inst.stat.out", OP_CAT_GPU_RSQRT64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SAD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SAD", "inst.stat.out", OP_CAT_GPU_SAD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SAD64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SAD64", "inst.stat.out", OP_CAT_GPU_SAD64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SELP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SELP", "inst.stat.out", OP_CAT_GPU_SELP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SELP64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SELP64", "inst.stat.out", OP_CAT_GPU_SELP64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SET = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SET", "inst.stat.out", OP_CAT_GPU_SET, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_GPU_SHR64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SHR64", "inst.stat.out", OP_CAT_GPU_SHR64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SIN = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SIN", "inst.stat.out", OP_CAT_GPU_SIN, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SLCT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SLCT", "inst.stat.out", OP_CAT_GPU_SLCT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SLCT64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SLCT64", "inst.stat.out", OP_CAT_GPU_SLCT64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SQRT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SQRT", "inst.stat.out", OP_CAT_GPU_SQRT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SQRT64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SQRT64", "inst.stat.out", OP_CAT_GPU_SQRT64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ST = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ST", "inst.stat.out", OP_CAT_GPU_ST, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_ST64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_ST64", "inst.stat.out", OP_CAT_GPU_ST64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SUB = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SUB", "inst.stat.out", OP_CAT_GPU_SUB, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SUB64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SUB64", "inst.stat.out", OP_CAT_GPU_SUB64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SUBC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SUBC", "inst.stat.out", OP_CAT_GPU_SUBC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SULD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SULD", "inst.stat.out", OP_CAT_GPU_SULD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SULD64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SULD64", "inst.stat.out", OP_CAT_GPU_SULD64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SURED = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SURED", "inst.stat.out", OP_CAT_GPU_SURED, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SURED64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SURED64", "inst.stat.out", OP_CAT_GPU_SURED64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SUST = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SUST", "inst.stat.out", OP_CAT_GPU_SUST, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SUST64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SUST64", "inst.stat.out", OP_CAT_GPU_SUST64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_SUQ = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_SUQ", "inst.stat.out", OP_CAT_GPU_SUQ, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_TESTP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_TESTP", "inst.stat.out", OP_CAT_GPU_TESTP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_TESTP64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_TESTP64", "inst.stat.out", OP_CAT_GPU_TESTP64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_TEX = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_TEX", "inst.stat.out", OP_CAT_GPU_TEX, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_TLD4 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_TLD4", "inst.stat.out", OP_CAT_GPU_TLD4, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_TXQ = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_TXQ", "inst.stat.out", OP_CAT_GPU_TXQ, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_TRAP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_TRAP", "inst.stat.out", OP_CAT_GPU_TRAP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_VABSDIFF = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_VABSDIFF", "inst.stat.out", OP_CAT_GPU_VABSDIFF, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_VADD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_VADD", "inst.stat.out", OP_CAT_GPU_VADD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_VMAD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_VMAD", "inst.stat.out", OP_CAT_GPU_VMAD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_VMAX = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_VMAX", "inst.stat.out", OP_CAT_GPU_VMAX, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_VMIN = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_VMIN", "inst.stat.out", OP_CAT_GPU_VMIN, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_VSET = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_VSET", "inst.stat.out", OP_CAT_GPU_VSET, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_VSHL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_VSHL", "inst.stat.out", OP_CAT_GPU_VSHL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_VSHR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_VSHR", "inst.stat.out", OP_CAT_GPU_VSHR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_VSUB = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_VSUB", "inst.stat.out", OP_CAT_GPU_VSUB, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_VOTE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_VOTE", "inst.stat.out", OP_CAT_GPU_VOTE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_XOR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_XOR", "inst.stat.out", OP_CAT_GPU_XOR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_XOR64 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_XOR64", "inst.stat.out", OP_CAT_GPU_XOR64, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_RECONVERGE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_RECONVERGE", "inst.stat.out", OP_CAT_GPU_RECONVERGE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_PHI = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_PHI", "inst.stat.out", OP_CAT_GPU_PHI, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEM_LD_GM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEM_LD_GM", "inst.stat.out", OP_CAT_GPU_MEM_LD_GM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEM_LD_LM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEM_LD_LM", "inst.stat.out", OP_CAT_GPU_MEM_LD_LM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEM_LD_SM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEM_LD_SM", "inst.stat.out", OP_CAT_GPU_MEM_LD_SM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEM_LD_CM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEM_LD_CM", "inst.stat.out", OP_CAT_GPU_MEM_LD_CM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEM_LD_TM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEM_LD_TM", "inst.stat.out", OP_CAT_GPU_MEM_LD_TM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEM_LD_PM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEM_LD_PM", "inst.stat.out", OP_CAT_GPU_MEM_LD_PM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEM_LDU_GM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEM_LDU_GM", "inst.stat.out", OP_CAT_GPU_MEM_LDU_GM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEM_ST_GM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEM_ST_GM", "inst.stat.out", OP_CAT_GPU_MEM_ST_GM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEM_ST_LM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEM_ST_LM", "inst.stat.out", OP_CAT_GPU_MEM_ST_LM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_MEM_ST_SM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_MEM_ST_SM", "inst.stat.out", OP_CAT_GPU_MEM_ST_SM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_DATA_XFER_GM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_DATA_XFER_GM", "inst.stat.out", OP_CAT_GPU_DATA_XFER_GM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_DATA_XFER_LM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_DATA_XFER_LM", "inst.stat.out", OP_CAT_GPU_DATA_XFER_LM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GPU_DATA_XFER_SM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GPU_DATA_XFER_SM", "inst.stat.out", OP_CAT_GPU_DATA_XFER_SM, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_NUM_PHYSICAL_PAGES = new COUNT_Stat("NUM_PHYSICAL_PAGES", "memory.stat.out", NUM_PHYSICAL_PAGES);
